...
%模型初值设定
%S1=59170000;%湖北省人口总数
S1=7700000000;%全球人口总数
N0=S1;
S2=S1;
S3=S1;
E1=592927;% 4月7至4月13日新增确诊病例数
E2=E1;
E3=E1;
I1=253190; %估计值，感染者
I2=I1;
I3=I1;
Sq1=1776000;%估计值，尚在接受医学观察的人数
Sq2=Sq1;
Sq3=Sq1;
Eq1=80000*7;%估计值，为正在被隔离的潜伏者
Eq2=Eq1;
Eq3=Eq1;
H1=Eq1+I1;%正在住院的患者，为感染者和被隔离的潜伏者之和
H2=H1;
H3=H1;
R1=444636;%官方公布的出院人数
R2=R1;
...
alpha2=2.7*10^(-4);%病死率
alpha3=2.7*10^(-4);%病死率
rho1=0.12;%有效接触系数，参考取1
rho2=0.13;%有效接触系数，参考取1
rho3=0.15;%有效接触系数，参考取1
theta1=0.1;%潜伏者相对于感染者的传染能力比值
theta2=0.1;%潜伏者相对于感染者的传染能力比值
theta3=0.1;%潜伏者相对于感染者的传染能力比值
...
plot(T,newinfected1,'LineWidth',2);
hold on;
plot(T,newinfected2,'LineWidth',2);
hold on;
plot(T,newinfected3,'LineWidth',2);
grid on;
